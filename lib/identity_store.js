...
IdentityStore.prototype = {
    ...
    */
    ...
    :param object optin_info:
      Gets passed through directly to service. Consult service docs/protocol.
      An example of identity object:
        {
            "identity": "uuid",
            "address_type": "msisdn",
            "address": "+27845000000"
    ...
    */
    optin: function(optin_info) {
        var endpoint = 'optin/';
        var url = this.base_url + endpoint;

        var payload = {
            "identity": optin_info.identity,
            "details": {
                "default_addr_type": null,
                "addresses": {}
            }
        ...
        // compile base payload
        if (optin_info) {
            var address_type = optin_info.address_type;
            var addresses = {};
            addresses[address_type] = {};
            addresses[address_type][optin_info.address] = {};
            payload.details = {
                "default_addr_type": optin_info.address_type,
                "addresses": addresses
            };
        }
