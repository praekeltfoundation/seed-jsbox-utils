...
IdentityStore.prototype = {
    ...
    */
    ...
    /**:IdentityStore.optin(optin_info)
    Posts an optin to the identity store optin endpoint
    ...
    */
    optin: function(optin_info) {
        ...
        return this.http_api.post(url, {data: optin_info})
            .then(this.log_service_call('POST', url, optin_info, null))
            .then(function(response) {
                return response.data;
            });
    },
