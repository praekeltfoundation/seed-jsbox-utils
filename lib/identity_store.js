...
IdentityStore.prototype.get = function(id) {
...
IdentityStore.prototype.search = function(address) {
...
// Returns the identity object
IdentityStore.prototype.create = function(address, options) {
...
IdentityStore.prototype.get_or_create = function(address, options, self) {
    return this.search(address)
        .then(function(identity) {
            if (identity !== null) {
                ...
                return self.create(address, options)
                    .then(function(identity) {
                        return identity;
                    });
            }
...
IdentityStore.prototype.update = function(id, identity) {
    var endpoint = 'identities/'+id+'/';
...
IdentityStore.prototype.optout = function(optout_info) {
    var endpoint = 'optout/';
