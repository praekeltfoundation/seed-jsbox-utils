...
IdentityStore.prototype = {
    ...
    // 'address' should be an object {address_type: address}
    ...
    //  'address' should be an object {address_type: address}
    //      eg. {'msisdn': '0821234444'}; {'email': 'me@example.com'}
    //  'options' = data/payload for POST request
    ...
    //  'address' should be an object {address_type: address}
    //      eg. {'msisdn': '0821234444'}; {'email': 'me@example.com'}
    //  'options' data/payload for POST request (create)
    ...
    // Parameter:
    //  - 'optout_info' should be an object
    // example of properties in optout_info object:
    //   "optout_type": string,
