...
Hub.prototype = {
    ...
    */
    create_registration: function(reg_info) {
        ...
        return this.http_api.post(url, {data: reg_info})
            .then(this.log_service_call('POST', url, reg_info))
    ...
    ?? does this function need to change an existing registration or do a create_or_change..??
    ...
    */
    create_change: function(registration) {
        ...
        return this.http_api.patch(url, {data: registration})
            .then(this.log_service_call('PATCH', url, registration))
            .then(function(response) {
                return reponse.data;
            });
    },
