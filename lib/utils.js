...
Returns today's date unless date is specified (as moment instance)

:param string date: Optional.
:param string format: Optional. Specifies the format of the date
...
get_moment_date = function(date, format) {
    ...
    if (date && is_valid_date(date, date_format)) {
