...
*/
get_paginated_response = function(service, url, params) {
    ...
    return service.http_api.get(url, {params: params})
        ...
        .then(function(response) {
            ...
            var next_path = next_url.href.replace(next_url.query, "");
            return get_paginated_response(service, next_path, next_url.query).
                then(function(page) {
