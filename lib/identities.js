...
// Returns the identity object
var create = function(address, options) {
...
var get_or_create = function(address, options) {
...
var update = function(id, identity) {
    var endpoint = 'identities/'+id+'/';
...
var optout = function(optout_info) {
    var endpoint = 'optout/';

    return http.post(base_url + endpoint, {data: optout_info})
        .then(function(response) {
            return response;
        });
};
